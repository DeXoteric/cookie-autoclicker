...
class CookieAutoclicker:
    ...
    def setup(self) -> None:
        ...
        self.options_btn = self.driver.find_element(By.CLASS_NAME, "subButton")
    ...
    def spawn_golden_cookie(self):
        while True:
            try:
                mana_text = self.driver.find_element(By.ID, "grimoireBarText")
                ...
                mana_cost = int(
                    self.driver.find_element(By.ID, "grimoirePrice1").text.strip()
                )
    ...
    def auto_load(self):
        ...
        load_btn = self.driver.find_element(By.ID, "promptOption0")
        load_btn.click()
    ...
    def save_to_file(self):
        ...
        string_to_save = self.driver.find_element(
            By.ID, "textareaPrompt"
        ).get_attribute("value")
        with open("./save.txt", "w", encoding="utf-8") as file:
            file.write(str(string_to_save))

        done_btn = self.driver.find_element(By.ID, "promptOption0")
        done_btn.click()
    ...
    def volume_off(self):
        self.options_btn.click()
        volume_slider = self.driver.find_element(By.ID, "volumeSlider")
        volume_slider.click()
